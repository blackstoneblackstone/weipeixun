package com.foxinmy.weixin4j.server.request;
 ...
 * @see com.foxinmy.weixin4j.server.message.event.LocationEventMessage
 * @see com.foxinmy.weixin4j.server.message.event.MenuEventMessage
 * @see com.foxinmy.weixin4j.server.message.event.MenuLocationEventMessage
 * @see com.foxinmy.weixin4j.server.message.event.MenuPhotoEventMessage
 * @see com.foxinmy.weixin4j.server.message.event.MenuScanEventMessage
 * @see com.foxinmy.weixin4j.server.mp.event.KfCloseEventMessage
 * @see com.foxinmy.weixin4j.server.mp.event.KfCreateEventMessage
 * @see com.foxinmy.weixin4j.server.mp.event.KfSwitchEventMessage
 * @see com.foxinmy.weixin4j.server.mp.event.MassEventMessage
 * @see com.foxinmy.weixin4j.server.mp.event.ScanEventMessage
 * @see com.foxinmy.weixin4j.server.mp.event.ScribeEventMessage
 * @see com.foxinmy.weixin4j.server.mp.event.TemplatesendjobfinishMessage
 * @see com.foxinmy.weixin4j.server.qy.event.BatchjobresultMessage
 * @see com.foxinmy.weixin4j.server.qy.event.EnterAgentEventMessage
 * @see com.foxinmy.weixin4j.server.qy.event.ScribeEventMessage
 */
