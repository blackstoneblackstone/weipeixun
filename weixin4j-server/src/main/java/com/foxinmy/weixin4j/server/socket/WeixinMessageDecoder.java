...
import com.foxinmy.weixin4j.server.xml.EncryptMessageHandler;
...
public class WeixinMessageDecoder extends
	...
	protected void decode(ChannelHandlerContext ctx, FullHttpRequest req,
		...
		logger.info("访问地址:\n{} 方法: \n{} ", req.getUri(),
				method);
		logger.info("请求解码前 message: \n{}", messageContent);
		Map<String, List<String>> parameters = queryDecoder.parameters();
		//TODO 此处原来是EncryptType encryptType = parameters.containsKey("encrypt_type") ? EncryptType
