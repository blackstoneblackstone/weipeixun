...
import com.foxinmy.weixin4j.dispatcher.*;
import com.foxinmy.weixin4j.exception.WeixinException;
import com.foxinmy.weixin4j.handler.*;
...
public final class WeixinServerBootstrap {
    ...
    public static void main(String[] args) {
        // 针对文本消息回复
        WeixinMessageHandler messageHandler = new SuiteMessageHandler();
...
//                    messageHandler, menuEventHandler, DebugMessageHandler.global).startup();
            ...
            new WeixinServerBootstrap(wpx,qlxz).addHandler(
                messageHandler, menuEventHandler,textMessageHandler, DebugMessageHandler.global).startup();
     ...
     * @param appid  公众号的应用ID(appid/corpid) 密文&兼容模式下需要填写
