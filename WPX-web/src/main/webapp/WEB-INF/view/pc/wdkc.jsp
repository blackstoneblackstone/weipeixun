            ...
            <div class="apply_r">
                <div class="apply_item pt0">
                    <div class="apply_icon fl"><a href="http://wbg.do1.com.cn/icon.html" title="点击下载图片" target="_blank"
                                                  rel="nofollow"><img src="<%=basePath%>/image/pc/icon_3.png" width="100px"
                                                                      height="100px"></a></div>
                    <div class="apply_item_wrap">
                        <div class="iblock">
                            <h3>我的课程</h3>
                            <span class=""><a href="http://wbg.do1.com.cn/scenario/scenario1/"
                                              target="_blank">场景：企业培训</a></span><span class="parent_apply"><a
                                href="http://wbg.do1.com.cn/suite/culture_suite/" target="_blank">所属套件：微培训套件</a></span>
                        </div>
                        <div class="apply_item_btn">
                            <a href="<%=basePath%>/auth/suite"
