package com.foxinmy.weixin4j.server.mp.model;
...
import com.foxinmy.weixin4j.server.mp.type.AutomatchMode;
import com.foxinmy.weixin4j.server.mp.type.AutoreplyMode;
...
public class AutoReplySetting implements Serializable {
	 ...
	 * 关注后自动回复的信息
	 * 
	 * @see com.foxinmy.weixin4j.server.mp.model.AutoReplySetting.Entry
	 */
	 ...
	 * 关键词自动回复的信息
	 * 
	 * @see com.foxinmy.weixin4j.server.mp.model.AutoReplySetting.Rule
	 */
	...
	public static class Rule implements Serializable {
		 ...
		 * 回复模式
		 * 
		 * @see com.foxinmy.weixin4j.server.mp.type.AutoreplyMode
		 */
	...
	public static class Entry implements Serializable {
		 ...
		 * 匹配模式(仅但关键字列表)
		 * 
		 * @see com.foxinmy.weixin4j.server.mp.type.AutomatchMode
		 */
